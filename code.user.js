...
if (location.host === "dio-david1327.github.io") { DIO_PAGE(); } // PAGE
    ...
    try {
        $('<script src="https://dio-david1327.github.io/DIO-TOOLS-David1327/Version.js?_"+Math.round(new Date().getTime()/60000)>').appendTo("head");
...
function DIO_GAME(dio_version, gm, DATA, time_a, url_dev) {
    ...
    uw.DIO_LANG = {
        ...
        //////////////////////////////////////////////
        br: { Notification: {}, link: { forum: "https://br.forum.grepolis.com/index.php?threads/script-dio-tools-david1327.23781/", }, Settings: { Settings: "", dsc: "DIO-Tools oferece, entre outras coisas, algumas telas, uma caixa de smiley, opções de comércio e algumas alterações no layout.", act: "Ativar/desativar recursos do conjunto de ferramentas:", prv: "Pré-visualização de vários recursos:", version_old: "Versão não está atualizada", version_new: "Versão está atualizada", version_dev: "Versão do desenvolvedor", version_update: "Atualização", Donate: "Doar", Update: "Atualizar", Feature: "Nova funcionalidade", Feature2: "Nova versão", Learn_more: "Saber mais", cat_units: "Unidades", cat_icons: "Cidades", cat_forum: "Forum", cat_trade: "Comércio", cat_wonders: "Maravilhas do Mundo", cat_layout: "Layout", cat_other: "Outros", cat_Premium: "Premium", cat_Quack: "Quack", install: "Instalar", reminder: "Lembrar mais tarde", Available: "Nova versão disponível", reqreload: "Atualização requerida", reload: "Atualizar", Comp_GRCT: "As seguintes funções não são compatíveis com GRCT", Non_compatible: "Não compatível, ative nas definições de", }, Options: { Options: "", ava: ["Visão geral da unidade", "Indica as unidades de todas as cidades"], ava2: ["Número do oceano", "Unidade de extensão"], sml: ["Smilies", "Estende o bbcode com uma caixa de smiley"], str: ["Força das Tropas", "Adiciona quadros de força das tropas em diversas áreas"], tra: ["Capacidade de Transporte", "Mostra a capacidade de transporte ocupado e disponível no menu de unidades"], per: ["Percentual de comércio", "Estende-se a janela de comércio com um percentual de comércio"], rec: ["Comércio para recrutamento", "Estende-se a janela de comércio com um comércio de recrutamento"], cnt: ["Conquistas", "Conta os ataques/apoios na janela de conquista"], way: ["Velocidade da tropa", "Displays mostram a possivél velocidade de tropa na janela de ataque/suporte"], sim: ["Simulador", "Adaptação do layout simulador & exposição permanente da caixa poderes estendida"], act: ["Ativar caixas suspensas de comércio e ataque", "Melhorias da exibição de caixas de comércio e recrutamento (com memória de posição)"], pop: ["Caixa de favores divino", "Altera a caixa de favores divino por um novo layout"], tsk: ["Barra de tarefas", "Aumenta a barra de tarefas"], rew: ["Recompensa diária", "Minimiza a janela recompensa diária no inicio"], bbc: ["Pedido de Apoio", "Estende a barra de bbcode com uma forma de Pedido de Apoio Automática"], com: ["Comparação de Unidades", "Adiciona tabelas de comparação de unidade"], tic: ["Ícones nas Cidades", "Cada cidade recebe um ícone para o tipo de tropas na cidade (detecção automática) ", " Ícones adicionais estão disponíveis para seleção manual"], tic2: ["Detecção automática", ""], til: ["Lista das Cidades", "Adiciona os ícones da cidade na lista de cidades"], tim: ["Mapa", "Mostra os ícones das cidades no mapa estratégico"], tiw: ["Pop-up de ícone", ""], wwc: ["Calculadora de WW", "Cálculo compartilhado & contador de recursos + botões anterior e próxima maravilhas do mundo (atualmente não desactivável!)"], wwr: ["Classificação", "Classificação das maravilha do mundo redesenhadas"], wwi: ["Icones", 'Adiciona ícones nas maravilha do mundo no mapa estratégico'], con: ["Menu de Contexto", 'Troca da "Selecione cidade" e "Visão Geral da Cidade" no menu de contexto'], sen: ["Unidades Enviadas", 'Shows sent units in the attack/support window'], tov: ["Visão da Cidade", 'Substitui o novo panorama da cidade, com o estilo da janela antiga'], scr: ["Roda do Mouse", 'Você pode alterar os pontos de vista com a roda do mouse'], Scr: ["Barra de deslocamento", "Altera a cor da barra de deslocamento"], tow: ["Cidade BBCode", "Adiciona o BBCode da cidade à aba da cidade"], Fdm: ["Selecione e apague várias mensagens", "Você pode excluir mais de uma mensagem. Função Quack"], Sel: ["Adicionar (Sem sobrecarga / Excluir)", "Melhoria de novas ferramentas na janela de ataque e suporte. Função Quack"], Cul: ["Visão geral da cultura (Administrador)", "Adicionar um contador para a festa na visualização de cultura. Função Quack"], Hot: ["Atalhos do teclado para Windows", "Isso muda sua vida"], Isl: ["Visualização da ilha", "Aumentar a altura da lista de cidades e vilas. Função Quack"], Ish: ["Visão geral das aldeias bárbaras (Capitão)", "Ocultar automaticamente a cidade. Função Quack"], Hio: ["Visão geral das Grutas (Administrador)", "Permitir o filtro de cidades"], Hid: ["Gruta", "Digita prata acima 15000 automaticamente no campo. Função Quack"], Tol: ["Lista de cidades em BB-Code", "Copiar e colar. Função Quack"], Cib: ["Botão de vista da cidade", "Adicionar um botão para abrir a vista da cidade ao menu lateral. Função Quack"], Ciw: ["Vista da cidade", "Mostrar vista para a cidade em uma janela. Função Quack"], Tti: ["Envie recursos para festivais", "Clique nele e só será enviado para um festival. Função Quack"], Mse: ["Mensagens do Código BB", "Converter mensagens em Código BB. Função Quack"], Rep: ["Relatórios", "Adicionando um filtro de cores. Função Quack"], BBt: ["Botão de BBCode nas informações do jogador", "Adiciona um botão de BBCode (jogador e aliança)"], Rtt: ["Remoção das dicas da unidade", ""], Cup: ["Avanço da Cultura (Administrador)", "Alterada a apresentação da barra de progresso e adicionada uma barra de progresso para as colheitas. Função de Akiway"], Cuo: ["Pontos de Cultura (Administrador)", "Adicione um contador para os Pontos de Cultura. Função Quack"], Rct: ["Comércio -> Contador de recursos (Administrador) ", " Uma contagem de todos os recursos em sua cidade"], FLASK: ["Não é compatível com a ativação nos parâmetros do FLASK-TOOLS", ""], Mole: ["Não é compatível com a ativação nos parâmetros do Mole Hole", ""], Cic: ["Vista da Cidade", "O modo de construção com vista para a cidade está selecionado por predefinição"], Cuc: ["Filtragem da visão geral da cultura (Administrador)", "Permitir ordenar as cidades"], Buc: ["Filtragem da visão geral do edifício (Administrador)", "Permitir ordenar as cidades"], BBl: ["Lista BBcode", "Gera uma lista em BBcode, ideal para exibir membros de alianças ou as cidades de um jogador"], Amm: ["Correio em massa (aliança)", "Adiciona um botão no perfil da aliança para facilitar o envio de mensagens em massa"], Onb: ["Número do oceano", "Integra número do oceano à visão da ilha, melhorando a navegação"], Idl: ["Jogador Inativo", "Exibe jogadores inativos para uma gestão mais eficaz. Desenvolvido por GREPODATA"], Saw: ["Salvar muralha", "Permite salvar as tropas na muralha"], Att: ["Alarme de ataque", "Receba alertas instantâneos quando estiver sob ataque, reforçando sua segurança"], Com: ["Coloração de mensagens", "Aplica uma cor às mensagens com base na sua origem (aliança, inimigo, pacto)."], err: ["Enviar automaticamente relatórios de erros", "Se você ativar essa opção, você pode ajudar a identificar erros."], }, Movement: { movement: "Movimento", off: "Ataque a caminho", offs: "Ataques a caminho", def: "Apoio a caminho", defs: "Apoios a caminho", }, Town_icons: { Town_icons: "Ícones das cidades", LandOff: "Ofensiva terrestre", LandDef: "Defensiva terrestre", NavyOff: "Ofensiva naval", NavyDef: "Defensiva naval", FlyOff: "Ofensiva aérea", FlyDef: "Defensiva aérea", Out: "Fora", Emp: "Vazia", }, Color: { Color: "Cor", Blue: 'Azul', Red: 'Vermelho', Green: 'Verde', Pink: 'Rosa', White: "Branco", }, labels: { labels: "Etiquetas", uni: "Visão Geral da unidade", total: "Global", available: "Disponível", outer: "Fora", con: "Selecionar cidade", std: "Padrão", gre: "Grepo", nat: "Natural", ppl: "Popular", Par: "Festa", oth: "Outros", hal: "Halloween", xma: "Natal", eas: "Páscoa", lov: "Amor", ttl: "Pedido de Apoio", inf: "Informação da cidade:", dev: "Desvio", det: "Unidades Detalhadas", prm: "Bônus Premium", sil: "Prata na Gruta", mov: "Movimentação de Tropas:", leg: "WW Maravilhas", stg: "Level", tot: "Total", str: "Força das Unidades", los: "Perdas", mod: "Sem modificador de influência", dsc: "Comparação de unidades", hck: "Impacto", prc: "Corte", dst: "Arremesso", sea: "Naval", att: "Ofensivo", def: "Defensivo", spd: "Velocidade", bty: "Saque (recursos)", cap: "Capacidade de trasporte", res: "Custo (recursos)", fav: "Favor", tim: "Tempo de recrutamento (s)", rat: "Proporção de recursos de um tipo de unidade", shr: "Compartilhamento da capacidade de armazenamento da cidade-alvo.", per: "Percentual de comércio", lab: "Unidades enviadas", rec: "Recursos", improved_movement: "Movimento de tropas melhorado", Tran: "Traduções", donat: "Doações", Happy: "Feliz Ano Novo!", Merry: "Ho Ho Ho Feliz Natal!", tow: "Cidade BBCode", loc: "", ingame_name: "Como este projeto exige muito trabalho e pode consumir bastante tempo, sou sempre muito grato por qualquer tipo de apoio. Por isso, gostaria de agradecer a todos que contribuíram para este projeto, seja por meio de doações, conhecimento, criatividade, relatórios de erros ou simplesmente com algumas palavras de incentivo.", raf: "Ao confirmar a página será atualizada", con: "", Volume: "", }, tutoriel: { tuto: "Informações úteis", reme: ["Agradeço a todos que contribuíram para o desenvolvimento de DIO-TOOLS-David1327", ""], Trou: "O que você precisa saber sobre as tropas do Grepolis - pontos fortes/fracos das unidades", util: "Uma variedade de ferramentas para Grepolis: estatísticas, mapas, ferramentas, scripts, fórum... estão todas listadas aqui.", }, Quack: { delete_mul: "Excluir várias mensagens", delete_sure: "Você realmente quer apagar essas mensagens?", no_selection: "Nenhuma mensagem selecionada", mark_All: "Marcar todos", no_overload: 'Sem sobrecarga', delete: 'Excluir', cityfestivals: 'Festival Urbano', olympicgames: 'Jogos Olímpicos', triumph: 'Desfile da Vitória', theater: 'Peças de Teatro' }, hotkeys: { hotkeys: 'Teclas de atalho', Senate: 'Senado', city_select: 'Seleção Cidade', last_city: 'Última cidade', next_city: 'Próxima cidade', jump_city: 'Ir para a cidade atual', administrator: 'Administrador', captain: 'Capitão', trade_ov: 'Troca', command_ov: 'Comandos', recruitment_ov: 'Recrutamento', troop_ov: 'Visão geral das tropasa', troops_outside: 'Tropas no exterior', building_ov: 'Edifícios', culture_ov: 'Cultura', gods_ov: 'Deuses', cave_ov: 'Grutas', city_groups_ov: 'Grupos de cidades', city_list: 'Lista de cidades', attack_planner: 'Planejador de ataques', farming_villages: 'Aldeias bárbaras', menu: 'Menu', city_view: 'Vista da cidade', messages: 'Mensagens', reports: 'Relatórios', alliance: 'Aliança', alliance_forum: 'Fórum da aliança', settings: 'Configurações', profile: 'Perfil', ranking: "Classificação", notes: 'Notas', chat: 'Chat', council: 'Conselho de Heróis', Configure: "Configurar atalhos", }, messages: { messages: "Mensagens", ghosttown: "Cidade-fantasma", no_cities: "Nenhuma cidade nesta ilha", all: "Tudo", export: "Converter mensagem em BB-Code", Tol: "Copiar e colar (Função Quack)", copy: "Copiar", bbmessages: "Mensagens do BB-Code", copybb: "BBCode foi copiado", écrit: "escreveu o seguinte:", cli: "A mensagem não foi copiada", }, caves: { caves: "Gruta", stored_silver: 'Moedas de prata armazenadss', silver_to_store: 'Moedas de prata armazenáveis', name: 'Nome', wood: 'Madeira', stone: 'Pedra', silver: 'Moedas de prata', search_for: "Pesquisar por", }, grepo_mainmenu: { grepo_mainmenu: "Menu principal do Grepo", city_view: 'Vista da cidade', island_view: 'Vista Ilha' }, transport_calc: { transport_calc: "Capacidade de transporte", recruits: "Contagem das unidades na fila de recrutamento", slowtrans: "Contar navios de transporte lentos", fasttrans: "Contar navios de transporte rápidos", Lack: "Falta", Still: "Ainda", pop: "população disponível. Para o", Optipop: "População ideal para", army: "Você não tem um exército.", }, reports: { reports: "Relatórios", choose_folder: "Escolher pasta", enacted: "lançou", conquered: "conquistou", spying: "espionando", spy: "Espião", support: "apoio", support2: "não é possível apoiar", supporting: "estacionadas", attacking: "atacando", farming_village: "aldeia bárbara", gold: "Você recebeu", Quests: "Missões", Reservations: "Sua reserva para", }, translations: { translations: '', info: 'Info', trans: "Tradução para o idioma", translations: 'Traduções', trans_sure: 'Tem certeza de que sua tradução está pronta para ser gerada?', trans_success: 'A tradução foi enviada com sucesso', trans_fail: 'A tradução não pôde ser enviada', trans_infotext1: 'Tradução disponível', trans_infotext2: 'Para modificar ou criar um novo idioma, escolha o idioma no menu suspenso', trans_infotext3: 'Quando um texto contém tags HTML (portanto, tudo que está entre <> colchetes) eu peço que você os mantenha onde os encontrou', trans_infotext4: 'Quando você terminar de traduzir, pressione', trans_infotext5: 'Para poder adicionar você aos créditos, seu apelido será gerado', trans_infotext6: 'Copie a mensagem gerada e cole-a em um comentário', please_note: 'Por favor, note', credits: 'Créditos', no_translation: 'Nenhuma tradução encontrada', choose_lang: 'Escolha o idioma', add_lang: 'Adicionar um novo idioma', language: 'Idioma', enter_lang_name: 'Por favor, digite um nome de idioma', send: 'Gerar mensagem', name: 'Nome', add_edit: "Adicionar / editar", }, wall: { wall: "Muralha", wallnotsaved: "Muralha não foi salva", wallsaved: "Muralha foi salva", msghuman: "Informação salva com sucesso", erreur: "Ocorreu um erro ao salvar", wantdeletecurrent: "Quer apagar o registo corrente da muralha?", deletecurrent: "Apagar o registo corrente", listsaved: "Muralha salva no dia", liststate: "Condição da muralha no dia", nosaved: "Sem backup", Auto: "Modo automático", }, Radar: { Radar: "Pesquisar cidades", find: "Pesquisar", maxunittime: "Tempo máximo", townname: "Cidade", unittime: "Tempo", townowner: "Dono", townreserved: "Reserva", townpoints: "Pontos mínima da cidade", btnsavedefault: "Salvar valores como padrão", all: "Qualquer cidade", showcities: "Pesquisar cidades", }, TSL: { TSL: "Lista de cidades ordenadas", tooltip: "Mostrar cidade ordenada", }, AO: { AO: "Visão geral da academia", }, ABH: { ABH: "Construtor de exércitos", unitframe: "selecione a sua unidade", description1: "Nesta cidade, você tem [population] de população livre", description2: "Que é o suficiente para recrutar [max_units]", description3: "Você [yesno] tem a pesquisa [research] concluída.", description4: "Você pode colocar no máximo [max_queue] unidades na fila", target: "escolha seu objetivo de construção", package: "pacote de recursos por remessa (unidades)", btnsave: "Salvar configurações", tooltipok: "clique para selecionar a unidade padrão para a qual você enviará os recursos", tooltipnotok: "a unidade não foi pesquisada", hasresearch: "TEM", noresearch: "NÃO TEM", settingsaved: "As configurações para [city] foram salvas", btnreset: "resetar", resleft: "recursos restantes para enviar", imgtooltip: "clique para preencher os recursos", }, Stats: { player: "Estatísticas do jogador", ally: "Estatísticas da aliança", town: "Estatísticas da cidade", inactive: "Inativo", chkinactive: "Mostrar jogadores inativos", }, buttons: { sav: "Salvar", ins: "Inserir", res: "Resetar" } },
        pt: {},
        //////////////////////////////////////////////
    ...
    var Options_def = {
        ...
        dio_Com: true,	// colorizeMessage
        dio_Toh: true,	// TownHero
    ...
    $('<style id="dio_version">' +
        ...
        '#dio_version_info .version_icon.green { filter:hue-rotate(0deg); -webkit-filter: hue-rotate(0deg); border: none;} ' +
    ...
    $('<style id="dio_settings_style">' +
        ...
        '#dio_hall table td.laurel.green { background: url("/images/game/ally/founder.png") no-repeat; height:18px; width:18px; background-size:100%; border: none;} ' +
    ...
    function settings() {
        ...
        $("#dio_tools").click(function () {
            ...
            if (!$('#dio_settings').get(0)) {
                ...
                var trans = [(DATA.test.lang ? "Actuel " + (DATA.test.lang).toUpperCase() : getTexts("translations", "translations")), getTexts("buttons", "res") + " (" + (LID).toUpperCase() + ")"];
                ...
                $('.settings-container').append(
                    ...
                    '<a href="' + Home_url + (dio.lang() == "fr" ? "/fr" : "/en") + '/wiki/unit-comparison.html" target="_blank">' + getTexts("Settings", "Learn_more") + '</a></p></td>' +
                    '</tr><tr>' +
                    '<td><img src="" alt="" /></td>' +
                    ...
                    '</tr><tr>' +
                    '<td><img src="' + Home_url + '/img/dio/settings/cities-BB-Code.png" alt="" style="transform: scale(1.25);" /></td>' +
                    ...
                    '</tr><tr>' +
                    '<td><img src="' + Home_url + '/img/dio/settings/Heros.png" alt="" style="transform: scale(1.25); margin: 10px 12px 16px 2px;" /></td>' +
                    '<td><div id="dio_Toh" class="checkbox_new"><div class="cbx_icon"></div><div class="cbx_caption">' + uw.DM.getl10n("heroes")?.collection?.heroes + '</div></div>' +
                    '<p>      </p><br></td>' +
                    '</tr></table>' +
                    ...
                    '<a href="' + Home_url + (dio.lang() == "fr" ? "/fr" : "/en") + '/wiki/message-export.html" target="_blank">' + getTexts("Settings", "Learn_more") + '</a></p><br></td>' +
                    '</tr><tr>' +
                    ...
                    '<td><img src="" alt="" /></td>' +
                    '<td><div id="dio_Com" class="checkbox_new"><div class="cbx_icon"></div><div class="cbx_caption">' + getTexts("Options", "Com")[0] + '</div></div>' +
                    '<p>' + getTexts("Options", "Com")[1] + '</p><br></td>' +
                    /*'</tr><tr>' +
                    '<td><img src="" alt="" /></td>' +
                ...
                $("#dio_langdiv").change(function () {
                    ...
                    else if ($(this).val() === getTexts("buttons", "res") + " (" + (LID).toUpperCase() + ")") {
                        DATA.test.lang = "";
                        deleteValue("test", JSON.stringify(DATA.test));
                        uw.HumanMessage.success(getTexts("translations", "translations") + " " + getTexts("buttons", "res") + " (" + LID + ")");
                    } else {
                        DATA.test.lang = lang;
                        saveValue("test", JSON.stringify(DATA.test));
    ...
    function setStyle() {
        ...
        $('<style id="dio_settings_style" type="text/css">' +
            ...
            '#dio_settings .green { color: green; border: none;} ' +
    ...
    function loadFeatures() {
        if (typeof (ITowns) !== "undefined") {
            ...
            if (Overviews.Culture == "") {
                Overviews.Culture = (uw.DM.getl10n("heroes")?.transfer?.hero_name ?? "????????Name");
                Overviews.Culture_Dif = ">";
                Overviews.Buildings = (uw.DM.getl10n("heroes")?.transfer?.hero_name ?? "????????Name");
                Overviews.Buildings_Dif = ">";
                Overviews.Gods = (uw.DM.getl10n("heroes")?.transfer?.hero_name ?? "????????Name");
                //Overviews.hour = 0;
                //Overviews.minute = 0;
    ...
    function ajaxObserver() {
        $(document).ajaxComplete(function (e, xhr, opt) {
            ...
            switch (action) {
                ...
                case "/notify/fetch":
                    if (DATA.options.dio_tim & uw.Game.layout_mode === "island_view") MapIcons.add();
                    //if (DATA.options.dio_Hid & $('#hide_espionage').length) hidesIndexIron.add2();
                    break;
                case "/player/index":
                    settings();
                    if (diosettings) {
                ...
                case "/message/send_forward":
                    if (DATA.options.dio_Com) colorizeMessage("List");
                    break;
                case "/message/view":
                    if (DATA.options.dio_Com) colorizeMessage("View");
                ...
                case "/frontend_bridge/refetch": {
                    ...
                    if (action === "/frontend_bridge/fetch") {
                        if (sentJson?.window_type === "hide") {
                            if (DATA.options.dio_Hid) setTimeout(() => { hidesIndexIron.add2(); }, 100);
                        }
    ...
    $('<style id="dio_window">' +
        ...
        '.dio_title { margin: 1px 6px 13px 2px; color: rgb(126,223,126); float: left; } ' +
        '</style>').appendTo('head');
    function createWindowType(name, title, width, height, minimizable, position) {
        ...
        WndHandler.prototype.getDefaultWindowOptions = function () {
            if (MID == 'zz' || dio_bug) {
                return {
                    ...
                    //title: title,
                    title: "<div class='dio_title'>" + title + "</div>"
                };
            } else {
                return {
                    position: position,
        ...
        uw.GPWindowMgr.addWndType(name, "", WndHandler, 1);
        //createtitre (name)
    }
    function createtitre(name, Return) {
        var BBwnd = uw.GPWindowMgr.Create(uw.GPWindowMgr["TYPE_" + name]) || uw.GPWindowMgr.getOpenFirst(uw.GPWindowMgr["TYPE_" + name]).close();
        BBwnd.getJQElement().parent().find(".ui-dialog-title").css({ "display": "none" });
        console.log()
        if (!BBwnd.getJQElement().parent().find(".dio_title_img").length) BBwnd.getJQElement().parent().find(".ui-dialog-title").before("<img class='dio_title_img' src='" + dio_img + "' /><div class='dio_title'>" + BBwnd.getJQElement().parent().find(".ui-dialog-title").text().trim() + "</div>");
        if (Return) return
        return BBwnd
    };
    ...
    var Notification = {
        ...
        init: () => {
            ...
            $('<style id="dio_notification" type="text/css">' +
                ...
                '#NotifText .green { color: green; border: none;} ' +
        ...
        update: () => {
            ...
            if (Notification.REMINDER == false) {
                ...
                var BBwnd = createtitre("DIO_Notification_v");
        ...
        activate: () => {
            ...
            function tab2() {
                ...
                var don, donNb = 0, reste, donationsListe = [
                    [1, 5, 104.8, 97.95, 'Sidney A'], [2, 45, 10, 83.09, 'Davryll'], [3, 4, 101.26, 94.9, 'Ines L'], [4, 34, 90.1, 75.48, 'adriano g'], [5, 6, 70, 65.87, 'Christiane G'], [6, 22, 53.24, 44, 'Andreas H'], [7, 1, 50, 47.2, 'Nepomuk P'], [7, 1, 50, 47.2, 'Michael G'], [7, 2, 50, 47.85, 'Artur Z'], [8, 1, 36.41, 34.28, 'Joao M'], [9, 2, 35, 33.28, 'Walther M'], [10, 3, 32.66, 30.66, 'Ulla R'], [11, 1, 31.26, 29.6, 'Nigel T'], [12, 2, 30, 28.43, 'lydie c'], [12, 3, 30, 27.48, 'elifoxo'], [12, 1, 30, 28.78, 'glaglatoulle'], [13, 1, 26.11, 25, 'Jean W'], [14, 4, 26.02, 23.86, 'etienne1306'], [15, 1, 25, 23.43, 'Kathleen J'], [16, 2, 21.32, 20, 'Heinz E'], [17, 1, 20, 19.07, 'Uwe S'], [17, 1, 20, 19.07, 'kanokwan s'], [17, 1, 20, 19.07, 'Werner S'], [17, 1, 20, 19.07, 'Elwira G'], [17, 1, 20, 19.07, 'Sven K'], [18, 1, 15, 14.21, 'Attila'], [19, 1, 12, 11.3, 'Detlef Z'], [20, 1, 10.66, 10, 'Martina V'], [20, 1, 10.66, 10, 'Arkadiusz W'], [20, 1, 10.66, 10, 'Iñaki S'], [21, 2, 10.51, 9.5, 'Kornelia M'], [22, 1, 10, 9.36, 'LILIANA P'], [22, 1, 10, 9.36, 'Herbert L'], [22, 1, 10, 9.36, 'Jean-Paul B'], [22, 1, 10, 9.36, 'filippo v'], [22, 1, 10, 9.36, 'Christian P'], [22, 1, 10, 9.36, 'Ocaso'], [22, 1, 10, 9.36, 'Andreas S'], [22, 1, 10, 9.36, 'Uwe J'], [22, 1, 10, 9.36, 'Andreas A'], [22, 1, 10, 9.36, 'benoit A'], [22, 1, 10, 9.16, 'Eric A'], [22, 1, 10, 9.36, 'Doris H'], [22, 1, 10, 9.36, 'SABINE B'], [22, 1, 10, 9.36, 'Ruud K'], [22, 1, 10, 9.36, 'Gabory A'], [23, 1, 7, 6.45, 'thomas c'], [24, 2, 6.42, 5.53, 'helder m'], [25, 1, 5.55, 5.04, 'Susi K'], [25, 1, 5.55, 5.04, 'Annette H'], [25, 1, 5.55, 5.04, 'Matthias H'], [26, 1, 5.51, 5, 'thomas s'], [26, 1, 5.51, 5, 'Arphox'], [26, 1, 5.51, 5, 'Laurent R'], [26, 1, 5.51, 5, 'Markus F'], [27, 1, 5, 4.5, 'Thomas C'], [27, 1, 5, 4.5, 'Sven O'], [27, 1, 5, 4.5, 'Sashaka'], [27, 1, 5, 4.5, 'Detlef Z'], [27, 1, 5, 4.5, 'Mateusz O'], [27, 1, 5, 4.5, 'florian p'], [27, 1, 5, 4.5, 'Denai'], [27, 1, 5, 4.5, 'Comte M'], [27, 1, 5, 4.5, 'José-Miguel A'], [27, 1, 5, 4.5, 'Kallerberg'], [27, 1, 5, 4.5, 'Ulrich S'], [27, 1, 5, 5.5, 'Max P'], [27, 1, 5, 4.4, 'Therese S'], [27, 1, 5, 4.5, 'Yvonne H'], [27, 1, 5, 4.5, 'Dorthe D'], [27, 1, 5, 4.5, 'Diana S'], [27, 1, 5, 4.5, 'Societatea-d-S B'], [27, 1, 5, 4.5, 'Dylan D'], [27, 1, 5, 4.5, 'Swen A'], [27, 1, 5, 4.5, 'Petr M'], [27, 1, 5, 4.5, 'Antonio-Acuña B'], [27, 1, 5, 4.5, 'Raul-Garcia C'], [28, 3, 3.39, 2.24, 'Gyorgy C'], [29, 1, 2.5, 2.08, 'Martin G'], [30, 2, 2.39, 1.62, 'Eduard B'], [30, 2, 2.39, 1.62, 'laurent k'], [31, 1, 2, 1.59, 'Marie-Laure D'], [31, 1, 2, 1.59, 'Ute N'], [32, 1, 1.39, 1, 'Puiu D'], [33, 1, 1, 0.38, 'Francesco L'],
                ];
            ...
            function tab3() {
                ...
                HTML_tab3 += '</div>' +
                    ...
                    '<div style="top: -37px;position: absolute; right: 92px;">' +
                    '<a class="ui-dialog-titlebar-help ui-corner-all" id="dio_help" href="' + Home_url + (dio.lang() == "fr" ? "/fr/wiki/traductions" : "/en/wiki/translations") + '.html" target="_blank"></a>' +
                    '<div id="dio_donate_btn" style="position:relative; right: -94px; top: 484px; -webkit-filter: hue-rotate(45deg);">' + dio.createBtnDonate(getTexts("Settings", "Donate"), null, null, 0, getTexts("link", "Donate")) + '</div>' +
                    '</div>';
            ...
            function handle_and_style() {
                ...
                $("#dioerrordio").click(() => {
                    ...
                    uw.hOpenWindow.showConfirmDialog('', getTexts("translations", "send"), function () {
                        ...
                        var BBwnd = createtitre("DIO_BBCODEE");
            ...
            var BBwnd = createtitre("DIO_Notification");
    ...
    setTimeout(() => {
        ...
        uw.layout_main_controller.sub_controllers[i].controller.town_groups_list_view.render = function () {
            ...
            if (DATA.options.dio_til & (typeof (uw.FLASK_GAME) == "undefined")) TownList.change();
            if (DATA.options.dio_Tol) if (!$('.dio_town_bb').get(0)) { townslist.add(); }
            if (DATA.options.dio_Toh) { TownHero.change(); }
            if (DATA.options.dio_Hid) setTimeout(() => { hidesIndexIron.add2(); }, 100);
    ...
    var TownHero = {
        activate: () => {
            // Town List open?
            if ($('#town_groups_list').get(0)) TownHero.change();
        },
        change: () => {
            ...
            $('#town_groups_list .grcrt_hero.hero_icon').css({ display: 'none' });
            $("#town_groups_list .town_group_town").each(function () {
                try {
                    var town_item = $(this), town_id = town_item.attr('name');
                    if (!town_item.find('.dio_hero.hero_icon').length) {
                        if (townHero[town_id]) town_item.prepend('<div class="dio_hero hero_icon hero25x25 ' + townHero[town_id].id + '"><div class="value" style="color: white; float: right; text-shadow: 1px 1px 0 #000; padding-top: 5px;" >' + townHero[town_id].level + '</div></div>')
                        ...
                        if (townHero[town_id]) $('<style id="" type="text/css">.dio_hero.hero_icon { display:inline-block !important;}</style>').appendTo('head');
                    }
                } catch (error) { errorHandling(error, "TownHero.change"); }
            });
        },
        deactivate: () => { $('.dio_hero.hero_icon').remove(); }
    };
    var TownList = {
        activate: () => {
            // Style town list
            $('<style id="dio_town_list" type="text/css">' +
                ...
                '#town_groups_list .dio_pop_percent { position: absolute; right: 6px; top:0px; font-size: 0.7em; display:block !important;} ' +
        ...
        deactivate: () => {
            ...
            $('#town_groups_list .dio_icon_small, #town_groups_list .dio_pop_percent').css({ display: 'none' });
                ...
                $("#town_groups_list .town_group_town").each(function () {
                    try {
                        ...
                        if (!town_item.find('dio_icon_small').length) {
                            ...
                            // TODO: Notlösung...
                            if (percent != -1) { percent_div = '<div class="dio_pop_percent ' + pop_space + '">' + percent + '%</div>'; }
    ...
    var AvailableUnits = {
        ...
        activate: () => {
            ...
            $('<style id="dio_available_units_style">' +
                ...
                '#dio_available_units .drop_box { position:absolute; top: -38px; right: 115px; } ' +
                ...
                '#dio_help_available_units a.ui-dialog-titlebar-help { background: url(https://gp' + LID + '.innogamescdn.com/images/game/layout/gpwindow_corners.png) no-repeat 0 -728px; width: 20px;} ' +
                '#dio_help_available_units a.ui-dialog-titlebar-help:hover { background: url(https://gp' + LID + '.innogamescdn.com/images/game/layout/gpwindow_corners.png) no-repeat 0 -748px; width: 20px;} ' +
        ...
        openWindow: () => {
            ...
            var land_units_str = "", content =
                ...
                '<a class="ui-dialog-titlebar-help ui-corner-all" href="' + Home_url + (dio.lang() == "fr" ? "/fr" : "/en") + '/wiki/units-overview.html" target="_blank"></a>' +
                '</div>' +
            ...
            AvailableUnits.wnd = createtitre("DIO_UNITS");
    ...
    var UnitComparison = {
        activate: () => {
            ...
            // Create Window Type
            createWindowType("DIO_COMPARISON", getTexts("labels", "dsc"), 520, 405, true, ["center", "center", 100, 100]);
            ...
            $('<style id="dio_comparison_style"> ' +
                ...
                '#dio_comparison_menu .tab_label { margin-left: 17px; } ' +

                '#dio_comparison_menu {top: -36px; right: 82px;} ' +
                ...
                '#dio_help_UnitComparison a.ui-dialog-titlebar-help { background: url(https://gp' + LID + '.innogamescdn.com/images/game/layout/gpwindow_corners.png) no-repeat 0 -728px; width: 20px;} ' +
                '#dio_help_UnitComparison a.ui-dialog-titlebar-help:hover { background: url(https://gp' + LID + '.innogamescdn.com/images/game/layout/gpwindow_corners.png) no-repeat 0 -748px; width: 20px;} ' +
                '#dio_minimize.ui-dialog-titlebar-minimize { background: url(https://gp' + LID + '.innogamescdn.com/images/game/layout/gpwindow_corners.png) no-repeat 0 -422px; width: 20px;} ' +
                '#dio_minimize.ui-dialog-titlebar-minimize:hover { background: url(https://gp' + LID + '.innogamescdn.com/images/game/layout/gpwindow_corners.png) no-repeat 0 -442px; width: 20px;} ' +
                '</style>').appendTo("head");
        },
        deactivate: () => {
        ...
        openWindow: () => {
            var content =
                ...
                '<li><a class="submenu_link sea" ><span class="left"><span class="right"><span class="middle">' +
                '<span class="tab_icon dio_icon_small2 townicon_so"></span><span class="tab_label">' + getTexts("labels", "sea") + '</span>' +
                '</span></span></span></a></li>' +
                '<li><a class="submenu_link distance"><span class="left"><span class="right"><span class="middle">' +
                '<span class="tab_icon dio_icon_small2 townicon_di"></span><span class="tab_label">' + getTexts("labels", "dst") + '</span>' +
                '</span></span></span></a></li>' +
                '<li><a class="submenu_link pierce"><span class="left"><span class="right"><span class="middle">' +
                '<span class="tab_icon dio_icon_small2 townicon_sh"></span><span class="tab_label">' + getTexts("labels", "prc") + '</span>' +
                '</span></span></span></a></li>' +
                '<li><a class="submenu_link hack active"><span class="left"><span class="right"><span class="middle">' +
                '<span class="tab_icon dio_icon_small2 townicon_lo"></span><span class="tab_label">' + getTexts("labels", "hck") + '</span>' +
                '</span></span></span></a></li>' +
                '</ul>' +

                '<div id="dio_help_UnitComparison" style="top: -37px;position: absolute; right: 62px;">' +
                '<a class="ui-dialog-titlebar-help ui-corner-all" href="' + Home_url + (dio.lang() == "fr" ? "/fr" : "/en") + '/wiki/unit-comparison.html" target="_blank"></a>' +
                '</div>' +
            ...
            var BBwnd = createtitre("DIO_COMPARISON");
            BBwnd.setContent(content);
            //uw.Layout.wnd.Create(uw.GPWindowMgr.TYPE_DIO_COMPARISON).setContent(content);
            //BBwnd.getJQElement().parent().find("a.ui-dialog-titlebar-minimize").css({ background : 'url(https://gp' + LID + '.innogamescdn.com/images/game/layout/gpwindow_corners.png) no-repeat 0 -422px', width : "20px" });
            BBwnd.getJQElement().parent().find("a.ui-dialog-titlebar-minimize").attr("id", "dio_minimize");
    ...
    var reports = {
        ...
        reportsFilter: () => {
            if (MID == 'fr' || MID == 'de' || MID == 'en' || MID == 'zz' || MID == 'cz' || MID == 'gr' || MID == 'nl' || MID == 'us' || MID == 'br' || MID == 'pt') {
                var b = uw.GPWindowMgr.getOpen(uw.Layout.wnd.TYPE_REPORT);
                if (b.length != 0) {
                    var wnd = b[b.length - 1];
                    var c = wnd.getID();
    ...
    var UnitStrength = {
        ...
        calcDef: (units) => {
            function parseUnitValue(value) { //conversion k
                if (typeof value === "number") return value; // déjà un nombre
            ...
            for (e in units) {
                if (units.hasOwnProperty(e)) {
                    let unitCount = parseUnitValue(units[e]); // conversion ici
                    blunt += unitCount * (uw.GameData.units[e].def_hack || 0);
                    sharp += unitCount * (uw.GameData.units[e].def_pierce || 0);
                    dist += unitCount * (uw.GameData.units[e].def_distance || 0);
                    console.log(units[e])
                    console.log(uw.GameData.units[e].def_hack)
                }
            }
        },
        ...
        activate: () => {
            try {
                ...
                $('<style id="dio_plusmenustyle" type="text/css">' +
                    '.displayImp {display: block !important; z-index: 4999 !important;}' +
    ...
    var buildingControl = {
        activate: () => {
            $('<style id="dio_buildingControl_style"> ' +
                ...
                '#buildings_control #dd_buildings_sort_by, #buildings_control #btn_buildings_direction, #buildings_control #txt_buildings_search { display: none !important; } ' +
                '#dio_building_sort_control .drop_group { float: right; } ' +
                '#buildings_control #dd_buildings_select_town_group { float: right; margin-top: -21px; } ' +
                '#buildings_control { padding: inherit; overflow: visible; } ' +

                '#dio_building_overview .dio_drop_Select .caption {padding-right: 9px !important; } ' +
                '</style>').appendTo("head");
            if ($('#building_overview_table_wrapper').length) { buildingControl.init(); }
        },
        init: () => {
            try {
                if ($('#dio_building_overview').length) {
                    if ($("#building_overview_container .sorting_asc").length || $("#building_overview_container .sorting_desc").length) {
                        let sorting = ($(".sorting_asc").length ? $("#building_overview_container .sorting_asc") : $("#building_overview_container .sorting_desc"))
                        selection = sorting[0].parentNode.className.split(" ")[2];
                        if (sorting[0].className.split(" ")[1] == undefined) sort($("#dio_building_overview .dio_drop_Select")[0].innerText, false, true);
                        else sort(selection, true, true);
                    }
                    else sort($("#dio_building_overview .dio_drop_Select")[0].innerText, false, true);
                    return
                }
                var buil = Overviews.Buildings, diff = Overviews.Buildings_Dif, selection;
                var sort_options = [
                    ["option_s", (uw.DM.getl10n("heroes")?.transfer?.hero_name ?? "????????Name"), true],
                    ["option_s ok", (uw.DM.getl10n("map")?.points?.name ?? "????????Points").replace(/^./, c => c.toUpperCase()), true],
                ...
                $("#buildings_control").before(
                    '<div id="dio_building_sort_control" class="overview_search_bar">' +
                ...
                setTimeout(() => {
                    ...
                    if (!$('#fixed_table_header #dio_sort').length) $('#fixed_table_header .building_icon40x40').append('<div id="dio_sort" class="sorting"></div>')
                ...
                function Classtest(buil) {
                    ...
                    if (buil == (uw.DM.getl10n("heroes")?.transfer?.hero_name ?? "????????Name") || buil == (uw.DM.getl10n("map")?.points?.name ?? "????????Points").replace(/^./, c => c.toUpperCase())) { }
                    ...
                    $('#fixed_table_header .' + buil).addClass("dio_sel")
                    if (buil === (uw.DM.getl10n("heroes")?.transfer?.hero_name ?? "????????Name")) {
                ...
                function sort(selection, filter, Sort) {
                    ...
                    switch (selection) {
                        case (uw.DM.getl10n("heroes")?.transfer?.hero_name ?? "????????Name"):
                            selection = 'a.gp_town_link';
                            break;
                        case (uw.DM.getl10n("map")?.points?.name ?? "????????Points").replace(/^./, c => c.toUpperCase()):
                    ...
                    var dio_ArrayUnsorted = $('#building_overview_table_wrapper>ul>li').get();
                ...
                function setfilter(selection) {
                    $('#txt_buildings_search input').off(); // supprime tous les handlers
                    $('#building_overview_table_wrapper>ul>li').show();
                    ...
                    if (isNumber($(uio).val())) {
                        ...
                        $('#building_overview_table_wrapper>ul>li').each(function (i, e) {
                            var selectedSort = "";
                ...
                $('#dio_sortfilterbox').attr('type', 'search').attr('placeholder', getTexts("caves", "search_for")).on("input", function () { suggestion(); });
        ...
        grepo_input: (number, Style, ID, Text) => {
            if (number) return $('<div class="input_box" style="' + Style + '"><span class="grepo_input"><span class="left"><span class="right"><input id="' + ID + '" type="number" min="0" placeholder="' + getTexts("caves", "search_for") + '" value="' + Text + '"></span></span></span></div>');
            else return $('<div class="input_box" style="' + Style + '"><span class="grepo_input"><span class="left"><span class="right"><input id="' + ID + '" type="search" placeholder="' + getTexts("caves", "search_for") + '" style="height: 22px;" value="' + Text + '"></span></span></span></div>');
        },
        deactivate: () => {
    ...
    var cultureControl = {
        ...
        init: () => {
            try {
                ...
                var selection;
                var sort_options = [
                    ["option", (uw.DM.getl10n("heroes")?.transfer?.hero_name ?? "????????Name"), true],
                ...
                $('#dio_culture_sort_control .filterstop').click(function () {
                    if ($(selec)[0].innerText === (uw.DM.getl10n("heroes")?.transfer?.hero_name ?? "????????Name")) { $('#dio_sortfilterbox')[0].value = ""; }
                    else {
                        $(hr_element)[0].value = "";
                        if (buil === uw.DM.getl10n("construction_queue")?.research_time?.split(":")[0]) {
        ...
        grepo_input: (Style, ID, Text) => {
            return $('<div class="input_box" style="' + Style + '"><span class="grepo_input"><span class="left"><span class="right"><input id="' + ID + '" type="search" placeholder="' + getTexts("caves", "search_for") + '" style="height: 22px;" value="' + Text + '"></span></span></span></div>');
        },
        deactivate: () => {
    ...
    console.log(5555, getTexts("caves", "search_for"))
    /*******************************************************************************************************************************
     * Hides Overview
     * ----------------------------------------------------------------------------------------------------------------------------
    ...
    var hidesIndexIron = {
        ...
        add2: () => {
            try {
                if ($("#dio_hidesIndexIron").is(":visible")) return
        ...
        init: () => {
            try {
                ...
                var sort_options = [
                    ...
                    ["name", (uw.DM.getl10n("heroes")?.transfer?.hero_name ?? getTexts("caves", "name"))],
                    ["wood", (uw.DM.getl10n("barracks")?.cost_details?.wood ?? getTexts("caves", "wood"))],
                    ["stone", (uw.DM.getl10n("barracks")?.cost_details?.stone ?? getTexts("caves", "Pierre"))],
                    ["iron", (uw.DM.getl10n("barracks")?.cost_details?.iron ?? getTexts("caves", "silver"))]
                ];
                ...
                $('#dio_sortinit').tooltip(dio_icon + (uw.DM.getl10n("heroes").transfer?.sort_by).replace(":", ""));
                $('#dio_sortfilterbox').attr('type', 'search').attr('placeholder', getTexts("caves", "search_for")).on("input", function () { sort($("#dio_sort_towns").val(), false) });
                ...
                if (DATA.options.dio_Ciw & (typeof (uw.MoleHoleOnBoard) == "undefined")) {
                    ...
                    $.Observer(city_overview).subscribe('dio_city_overview_window', (e, data) => {
                        if (DATA.options.dio_Ciw & (typeof (uw.MoleHoleOnBoard) == "undefined")) {
                            ...
                            var wnd = createtitre("DIO_TOWNOVERVIEW");
    ...
    uw.DIO_hotkeysConfig = {
        ...
        activate: () => {
            try {
                ...
                let footer = '<div id="aide"><div class="défaut_s"></div><div class="checkbox_new large" style="margin: 0 10px 0 20px;"><div class="cbx_icon"></div><div class="cbx_caption">a/A</div></div><div class="checkbox_new large checked"><div class="cbx_icon"></div><div class="cbx_caption">aA</div></div>';
                ...
                $("#dio_BTN_HK").click(() => {
                    try {
                        ...
                        const wnd = createtitre("DIO_HOTKEY");
    ...
    var townslist = {
            ...
            try {
                ...
                if (!$('#town_groups_list a.town_bb').length != 0) {
                    ...
                    $('.dio_town_bb').click(function (e) {
                        ...
                        const wnd = createtitre("DIO_BBCODE");
        ...
        content: (bb_count, town) => {
            return "[*]" + bb_count + ".[|][town]" + town.attributes.town_id + "[/town][|]" + town.town_model.attributes.points + " " + (uw.DM.getl10n("map")?.points?.name ?? "????????Points").replace(/^./, c => c.toUpperCase()) + "[|]" + uw.DM.getl10n("tooltips").ocean + " " + town.town_model.attributes.sea_id + "[/*]\n";
        },
        deactivate: () => {
    ...
    var BBcodeList = {
        ...
        player_towns: () => {
            try {
                ...
                let wnd = uw.GPWindowMgr.getFocusedWindow() || false, wndID = wnd.getID()
                if (!$('#gpwnd_' + wndID + ' #player_towns #dio_player_towns').get(0)) {
                    ...
                    $('#dio_island_info').click(function (e) {
                        ...
                        Cities.each(function () {
                            ...
                            if (townIdMatch && townIdMatch[1]) {
                                ...
                                let alliance = "[ally]" + $($(this).find('.gp_alliance_link')[0]).text() + "[/ally]";
            ...
            try {
                ...
                if (!$("#dio_messageExport").is(":visible")) {
                    ...
                    $("#dio_messageExport").click(function () {
                        ...
                        let expRahmen_e = '<div id="dio_help_MessageExport" style="top: -37px;position: absolute; right: 92px;"><a class="ui-dialog-titlebar-help ui-corner-all" href="' + Home_url + (dio.lang() == "fr" ? "/fr" : "/en") + '/wiki/message-export.html" target="_blank"></a></div>';
                        ...
                        const BBwnd = createtitre("DIO_BBCODEE");
    ...
    *******************************************************************************************************************************/
    ...
    var idle = {
        ...
        add: (action, b) => {
            ...
            if (action == "message") each = '#message_message_list #message_partner .gp_player_link';
